          ...
          <form class="checkout-form" ref="checkoutForm" @submit.prevent>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select v-if="form.pais === 'México' || form.pais === 'Mexico'" required class="form-input" v-model="form.estado" @change="checkShippingSupport">
                ...
                <input v-else type="text" required placeholder="Estado / Provincia / Región" v-model="form.estado" @blur="checkShippingSupport" class="form-input">
              </div>
              <div class="form-group">
